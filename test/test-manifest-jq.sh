...
# These patterns will be used in .claude/toolbox/scripts/template-sync.sh for reading manifests
# and in .claude/toolbox/scripts/template-cleanup.sh for generating manifests
set -euo pipefail
