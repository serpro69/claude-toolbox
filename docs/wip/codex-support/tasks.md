...
- [ ] 1.3 Create `cmd/generate-kodex/skills.go` — skill generation: iterate `klaude-plugin/skills/*/SKILL.md`, apply transform pipeline, write to `kodex-plugin/skills/*/SKILL.md`
