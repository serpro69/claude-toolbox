...
1. **Understand the current state of the project** in our working directory to know where we're starting off.
2. **Check the contributing guidelines and any relevant documentation** at CONTRIBUTING.md and `docs` directory
3. Ask me questions, one at a time, to **help refine the idea**. 
...
4. Once you believe you understand what we're trying to achieve, stop and **describe the whole design** to me, **in sections of 200-300 words at a time**, **asking after each section whether it looks right so far**.
5. Then document in .md files the entire design and write a comprehensive implementation plan in `/docs/wip/[feature-title]/{design,implementation}.md`. Feel free to break out the design/implementation documents into multi-part files, if necessary.
6. **When documenting design and implementation plan**:
...
8. Create a new task-master PRD based on the design.
9. Parse the task-master PRD with research.
10. Expand the new task into subtasks with links to existing design and implementation documents.
